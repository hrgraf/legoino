...
std::string Lpf2HubEmulation::getPortInformationPayload(DeviceType deviceType, byte port, byte informationType)
{
  ...
  else if (deviceType == DeviceType::MOVE_HUB_TILT_SENSOR)
  {
    ...
    {
    case 0x01:
      payload.append(std::string{0x06, 0x08, 0xFF, 0x00, 0x00, 0x00});
      break;
    case 0x02:
      payload.append(std::string{0x1F, 0x00});
      break;
    default:
      break;
    }
...
std::string Lpf2HubEmulation::getPortModeInformationRequestPayload(DeviceType deviceType, byte port, byte mode, byte modeInformationType)
{
  ...
  if (deviceType == DeviceType::MOVE_HUB_TILT_SENSOR)
  {
    ...
    if (mode == 0x00)
    {
      ...
      {
      case 0x00: payload.append(std::string{0x41, 0x4E, 0x47, 0x4C, 0x45, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}); break;
      case 0x01: payload.append(std::string{0x00, 0x00, 0xB4, 0xC2, 0x00, 0x00, 0xB4, 0x42}); break;
      case 0x02: payload.append(std::string{0x00, 0x00, 0xC8, 0xC2, 0x00, 0x00, 0xC8, 0x42}); break;
      case 0x03: payload.append(std::string{0x00, 0x00, 0xB4, 0xC2, 0x00, 0x00, 0xB4, 0x42}); break;
      case 0x04: payload.append(std::string{0x44, 0x45, 0x47, 0x00}); break;
      case 0x05: payload.append(std::string{0x50, 0x00}); break;
      case 0x80: payload.append(std::string{0x02, 0x00, 0x03, 0x00}); break;
      }
    }
    ...
    if (mode == 0x01)
    {
      switch (modeInformationType)
      {
      case 0x00: payload.append(std::string{0x54, 0x49, 0x4C, 0x54, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}); break;
      case 0x01: payload.append(std::string{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x20, 0x41}); break;
      case 0x02: payload.append(std::string{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xC8, 0x42}); break;
      case 0x03: payload.append(std::string{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x20, 0x41}); break;
      case 0x04: payload.append(std::string{0x44, 0x49, 0x52, 0x00}); break;
      case 0x05: payload.append(std::string{0x44, 0x00}); break;
      case 0x80: payload.append(std::string{0x01, 0x00, 0x01, 0x00}); break;
      }
    }
    ...
    if (mode == 0x02)
    {
      switch (modeInformationType)
      {
      case 0x00: payload.append(std::string{0x4F, 0x52, 0x49, 0x4E, 0x54, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}); break;
      case 0x01: payload.append(std::string{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xA0, 0x40}); break;
      case 0x02: payload.append(std::string{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xC8, 0x42}); break;
      case 0x03: payload.append(std::string{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xA0, 0x40}); break;
      case 0x04: payload.append(std::string{0x44, 0x49, 0x52, 0x00}); break;
      case 0x05: payload.append(std::string{0x10, 0x00}); break;
      case 0x80: payload.append(std::string{0x01, 0x00, 0x01, 0x00}); break;
      }
    }
    ...
    if (mode == 0x03)
    {
      switch (modeInformationType)
      {
      case 0x00: payload.append(std::string{0x49, 0x4D, 0x50, 0x43, 0x54, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}); break;
      case 0x01: payload.append(std::string{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xC8, 0x42}); break;
      case 0x02: payload.append(std::string{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xC8, 0x42}); break;
      case 0x03: payload.append(std::string{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xC8, 0x42}); break;
      case 0x04: payload.append(std::string{0x49, 0x4D, 0x50, 0x00}); break;
      case 0x05: payload.append(std::string{0x08, 0x00}); break;
      case 0x80: payload.append(std::string{0x01, 0x02, 0x04, 0x00}); break;
      }
    }
    ...
    if (mode == 0x04)
    {
      switch (modeInformationType)
      {
      case 0x00: payload.append(std::string{0x41, 0x43, 0x43, 0x45, 0x4C, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}); break;
      case 0x01: payload.append(std::string{0x00, 0x00, 0x82, 0xC2, 0x00, 0x00, 0x82, 0x42}); break;
      case 0x02: payload.append(std::string{0x00, 0x00, 0xC8, 0xC2, 0x00, 0x00, 0xC8, 0x42}); break;
      case 0x03: payload.append(std::string{0x00, 0x00, 0x82, 0xC2, 0x00, 0x00, 0x82, 0x42}); break;
      case 0x04: payload.append(std::string{0x41, 0x43, 0x43, 0x00}); break;
      case 0x05: payload.append(std::string{0x10, 0x00}); break;
      case 0x80: payload.append(std::string{0x03, 0x00, 0x03, 0x00}); break;
      }
    }
    ...
    if (mode == 0x05)
    {
      switch (modeInformationType)
      {
      case 0x00: payload.append(std::string{0x4F, 0x52, 0x5F, 0x43, 0x46, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}); break;
      case 0x01: payload.append(std::string{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xC0, 0x40}); break;
      case 0x02: payload.append(std::string{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xC8, 0x42}); break;
      case 0x03: payload.append(std::string{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xC0, 0x40}); break;
      case 0x04: payload.append(std::string{0x53, 0x49, 0x44, 0x00}); break;
      case 0x05: payload.append(std::string{0x10, 0x00}); break;
      case 0x80: payload.append(std::string{0x01, 0x00, 0x01, 0x00}); break;
      }
    }
    ...
    if (mode == 0x06)
    {
      switch (modeInformationType)
      {
      case 0x00: payload.append(std::string{0x49, 0x4D, 0x5F, 0x43, 0x46, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}); break;
      case 0x01: payload.append(std::string{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x7F, 0x43}); break;
      case 0x02: payload.append(std::string{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xC8, 0x42}); break;
      case 0x03: payload.append(std::string{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x7F, 0x43}); break;
      case 0x04: payload.append(std::string{0x53, 0x45, 0x4E, 0x00}); break;
      case 0x05: payload.append(std::string{0x10, 0x00}); break;
      case 0x80: payload.append(std::string{0x02, 0x00, 0x03, 0x00}); break;
      }
    }
    ...
    if (mode == 0x07)
    {
      switch (modeInformationType)
      {
      case 0x00: payload.append(std::string{0x43, 0x41, 0x4C, 0x49, 0x42, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}); break;
      case 0x01: payload.append(std::string{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x7F, 0x43}); break;
      case 0x02: payload.append(std::string{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xC8, 0x42}); break;
      case 0x03: payload.append(std::string{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x7F, 0x43}); break;
      case 0x04: payload.append(std::string{0x43, 0x41, 0x4C, 0x00}); break;
      case 0x05: payload.append(std::string{0x10, 0x00}); break;
      case 0x80: payload.append(std::string{0x03, 0x00, 0x03, 0x00}); break;
      }
    }
